...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--conda-sh", "--conda_sh", dest="conda_sh", default="/home/lixingfeng/anaconda3/etc/profile.d/conda.sh")
    parser.add_argument("--conda-env", "--conda_env", dest="conda_env", default="modelopt")
    parser.add_argument("--python-bin", "--python_bin", dest="python_bin", default="/home/lixingfeng/miniconda3/envs/modelopt/bin/python")
