...
def run(args: argparse.Namespace) -> int:
    ...
    write(args.output_root / "reports/latency_results.json", {"protocol": {"warmup": 200, "timed": 500, "repeats": 5, "scope": "pure TensorRT execute_async_ms", "gpu_uuid": args.gpu_uuid}, "controls": results})
