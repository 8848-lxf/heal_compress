...
def build_trt_command(
    ...
    *,
    ...
    if policy.strongly_typed:
        # Backward-compatible non-production callers may leave the legacy
        # booleans at their defaults; they are ignored below.  A production
        # request must be internally unambiguous and therefore fails closed.
